 ...
 */
export async function normalizeAudio(audioBuffer, mimeType = "audio/wav") {
  try {
 ...
 */
async function normalizeWithFFmpeg(audioBuffer, mimeType) {
 ...
 */
export async function generateEmbedding(normalizedAudio) {
  try {
...
export async function createVoiceBundle(params) {
  const {
    ...
    normalizedAudio,
    embedding,
    previewAudio, // Optional preview clip
  } = params;
